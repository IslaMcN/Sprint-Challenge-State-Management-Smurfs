...
- [ ] What problem does the context API help solve?
  React Context is a way for a child component to access a value in a grandparent component. Before we would have to use prop drilling for that data. This allows any decendent to have access to that information.
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
  Actions is what the app uses to change the state. The reducer is what implements that change. Store is literally a storage of that state off to the side of our app. It's the single source of truth because it holds all of our data. 
- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
  Your application state is global, and your component state is local. You can use application state if you have a large app that you want the same data to be passed through multiple layers of components. Personally I would only use component state if I had a small app that required minimal prop drilling.
- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
  Redux Thunk is a middleware that lets you call action creators that return a function instead of an action object. 
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
  Context API is probably my favorite. It was just easier for me to grasp. I'm sure once I get the hang of it I will like Redux more. Context API never made me cry like Redux did.
